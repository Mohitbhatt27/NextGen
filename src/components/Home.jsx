...
function Home() {
  ...
  return (
    <div className='min-h-full background-container'>
      <div className='relative z-10 py-52 flex gap-2 flex-col justify-center px-20'>
        ...
        <motion.button initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:0.55,delay:1.5}} className='rounded-full border-2 border-white text-xl font-semibold text-white w-24 px-3 py-1 tracking-wide'>Explore</motion.button>
      </div>
    </div>
  )
}
