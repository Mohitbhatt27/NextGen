...
function ProCard({image,title,price,className=''}) {
  ...
  return (
    <div className={`${className} bg-gray-100 border w-fit flex flex-col items-center rounded-md shadow-xl p-3 pb-4`}>
      ...
      <button className='mt-2 bg-emerald-500 hover:bg-emerald-600 px-3 text-white py-1 text-base sm:text-lg rounded-xl rounded-bl-none rounded-tr-none'>Add to Cart</button>
    </div>
  )
}
