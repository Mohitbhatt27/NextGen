...
function Counter() {
  return (
    <motion.div initial={{opacity:0,scale:0}} whileInView={{opacity:1,scale:1}} transition={{ delay: 0.2, duration: 0.4 }} className='py-5 md:py-10 px-5 flex flex-col gap-2 sm:gap-8 md:flex-row justify-around items-center md:gap-5 bg-emerald-500'>
      <div className='text-center font-nunito'>
        ...
        <span className='text-gray-100 text-sm md:text-base'>With years of expertise, NextGen crafts premium herbal products that combine the essence of nature with the power of wellness.</span>
      </div>
      <div className='text-center font-nunito'>
