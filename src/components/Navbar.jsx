...
function Navbar() {
  ...
  return (
    <>
      <div className='fixed top-0 z-20 w-full flex text-white justify-around items-center backdrop-blur-sm p-4' >
        ...
        <div className='flex gap-10 text-xl font-medium'>
          <NavLink to='' className={({isActive})=>`${isActive?'text-green-600':''} hover:underline`}>Home</NavLink>
          <NavLink to='about' className={({isActive})=>`${isActive?'text-green-600':''} hover:underline`}>About Us</NavLink>
